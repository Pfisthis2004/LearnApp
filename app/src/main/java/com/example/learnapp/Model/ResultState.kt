...
sealed class ResultState {
    ...
    data class OrderingResult(val isCorrect: Boolean, val userAnswerList: List<String>,val userAnswer: String = userAnswerList.joinToString(" "), val correctAnswer: String): ResultState()
}